...
export const registernAPI = (fullName: string, email: string, password: string, phone: string) => {
...
export const updateUsersAPI = (_id: string, fullName: string, phone: string) => {
    const urlBackend = `/api/v1/user`
